...
| OPEN-05 | Forme de l'aide **UNDERSTAND** (US-03) | Ouvert — décision produit : vocabulaire au tap ? traduction à la demande ? survol ? La prochaine slice (US-03) est proposée mais non démarrée faute de cette décision. | Définit l'étape UNDERSTAND de la boucle | Non (n'empêche pas US-01/US-02) |
