...
| R4 | Validation nominale | Choisir un niveau + au moins un intérêt, cliquer « Start discovering » | Passage à l'écran de résumé « Your journey is ready » affichant langue, niveau, intérêts choisis. |
