...
const EN: Dict = {
  ...
  "progress.title": "{level} sub-levels",
  "progress.threshold": "A sub-level is acquired once all its units are done and the composite score reaches {pct}%.",
  "progress.soon": "Content coming soon.",
  "progress.retry_hint": "Redo only the units below the threshold to acquire this sub-level.",
  "progress.status_acquired": "Acquired",
  "progress.status_retry": "Retry",
...
const FR: Dict = {
  ...
  "progress.title": "Sous-jalons {level}",
  "progress.threshold": "Un sous-jalon est acquis quand toutes ses unités sont faites et que la note composite atteint {pct} %.",
  "progress.soon": "Contenu à venir.",
  "progress.retry_hint": "Refaites uniquement les unités sous le seuil pour acquérir ce sous-jalon.",
  "progress.status_acquired": "Acquis",
  "progress.status_retry": "À rattraper",
