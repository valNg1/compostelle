...
const EN: Dict = {
  ...
  "use.valid_expr_only": "Expression used ✓ — only the expression was checked, not the full grammar.",
  ...
  "use.assessment_correct": "Good — your sentence is correct.",
  "use.assessment_understandable": "Good attempt — your sentence is understandable.",
  "use.assessment_missing": "Let's try again — use the target expression.",
  "use.corrected_label": "Corrected version:",
  "use.retry": "Try again",
  ...
  "progress.free_access": "Play anything, in any order. Your acquisition score ({pct}%) is a guide, not a gate.",
  "progress.empty": "Content coming soon for level {level}.",
  "progress.suggestion": "{n} exercise(s) below {pct}% — want to replay them?",
  "progress.status_acquired": "Acquired",
  "progress.status_retry": "Keep practising",
  "progress.status_in-progress": "In progress",
  "progress.play": "Play",
  "progress.redo": "Redo",
  "progress.no_quiz": "no quiz — scored on reuse + corrections",
  "action.aria": "What you can do",
  "action.start": "Start learning",
  "action.continue": "Continue learning",
  "action.redo": "Redo a lesson",
  "quiz.finish": "Finish unit",
  "quiz.recap_title": "Your recap",
  "quiz.score_quiz": "Quiz: {pct}",
  "quiz.score_reuse": "Reuse: {pct}",
  "quiz.score_corrections": "Corrections: {pct}",
  "quiz.replay_wrong": "Replay the {n} wrong",
  "quiz.done": "Done",
...
const FR: Dict = {
  ...
  "use.valid_expr_only": "Expression bien employée ✓ — seule l'expression a été vérifiée, pas toute la grammaire.",
  "use.needs_correction":
  ...
  "use.issue_nature": "Nature :",
  "use.assessment_correct": "Bien — votre phrase est correcte.",
  "use.assessment_understandable": "Bonne tentative — votre phrase est compréhensible.",
  "use.assessment_missing": "Réessayons — utilisez l'expression cible.",
  "use.corrected_label": "Version corrigée :",
  "use.retry": "Réessayer",
  ...
  "progress.free_access": "Jouez ce que vous voulez, dans l'ordre que vous voulez. Votre note d'acquisition ({pct} %) est un repère, pas une barrière.",
  "progress.empty": "Contenu à venir pour le niveau {level}.",
  "progress.suggestion": "{n} exercice(s) sous {pct} % — envie de les rejouer ?",
  "progress.status_acquired": "Acquis",
  "progress.status_retry": "À consolider",
  "progress.status_in-progress": "En cours",
  "progress.play": "Jouer",
  "progress.redo": "Refaire",
  "progress.no_quiz": "sans quiz — noté sur réutilisation + corrections",
  "action.aria": "Ce que vous pouvez faire",
  "action.start": "Commencer un apprentissage",
  "action.continue": "Poursuivre l'apprentissage",
  "action.redo": "Refaire une leçon",
  "quiz.finish": "Terminer l'unité",
  "quiz.recap_title": "Votre récap",
  "quiz.score_quiz": "Quiz : {pct}",
  "quiz.score_reuse": "Réutilisation : {pct}",
  "quiz.score_corrections": "Corrections : {pct}",
  "quiz.replay_wrong": "Rejouer les {n} fausses",
  "quiz.done": "Terminé",
